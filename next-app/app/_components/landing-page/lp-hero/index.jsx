...
export default function LandingHero() {
    return (
        <div className="relative rounded-[0_0_2rem_2rem] overflow-clip after:absolute after:inset-0 after:bg-radial after:from-transparent after:from-80% after:to-dance-reg">
            ...
            <div className="w-full flex flex-col gap-8 items-center absolute top-16 left-1/2 -translate-x-1/2">
                ...
                <div className="relative">
                    ...
                    <hr className="mt-2 border-3 absolute -left-[300%] border-dance-e9 w-[400%] animate-fade-in-ltr" />
                </div>
