...
export default function ActivityCard({ title, subtitle, description, img }) {
    ...
    return (
        <li className="list-none font-ubuntu aspect-square w-full animate-fade-in-scale">
            <figure className="cust-shape overflow-clip grid *:col-start-1 *:row-start-1 size-full">
                ...
                {
                    title &&
                    (<figcaption className="flex flex-col gap-1 self-end px-6 py-2 w-full bg-dance-drk/75 backdrop-blur-xs text-left">
